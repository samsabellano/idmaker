...
__webpack_require__(/*! ./transaction */ "./resources/js/transaction.js");
__webpack_require__(/*! ./webidmaker */ "./resources/js/webidmaker.js");
...
var guardianFullName = document.getElementById("guardianFullName");
var guardianContactNumber = document.getElementById("guardianContactNumber");
var guardianCompleteAddress = document.getElementById("guardianCompleteAddress");
...
guardianCompleteAddress.addEventListener("input", function () {
  document.getElementById("previewGuardianCompleteAddress").textContent = this.value;
});
guardianContactNumber.addEventListener("input", function () {
  document.getElementById("previewGuardianContactNumber").textContent = this.value;
});
...
var shortenedMiddleName = function shortenedMiddleName() {
  var middleNameElement = document.getElementById("previewMiddleName");
  var middleNameResult = middleName.value.charAt(0).toUpperCase();
  if (middleNameResult) {
    middleNameElement.textContent = "".concat(middleNameResult, ".");
  } else {
    middleNameElement.textContent = "";
  }
  var words = middleName.value.split(" ");
  for (var i = 0; i < words.length; i++) {
    var word = words[i];
    words[i] = word.charAt(0).toUpperCase() + word.slice(1);
  }
...
var personSuffix = function personSuffix() {
  var suffixElement = document.getElementById("previewSuffix");
...
var btnSaveIdRecord = document.getElementById("btnSaveIdRecord");
var IDFront = document.getElementById("IDFront");
var IDBack = document.getElementById("IDBack");
btnSaveIdRecord.onclick = function () {
  dom_to_image__WEBPACK_IMPORTED_MODULE_0___default().toBlob(IDFront).then(function (blob) {
    window.saveAs(blob, "front.png");
  });
  dom_to_image__WEBPACK_IMPORTED_MODULE_0___default().toBlob(IDBack).then(function (blob) {
...
/***/ "./resources/sass/dependencies.scss":
/*!******************************************!*\
  !*** ./resources/sass/dependencies.scss ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/******/ 	__webpack_require__.O(undefined, ["css/dependencies","css/app","css/fontawesome","css/auth"], () => (__webpack_require__("./resources/js/app.js")))
/******/ 	__webpack_require__.O(undefined, ["css/dependencies","css/app","css/fontawesome","css/auth"], () => (__webpack_require__("./resources/sass/auth.scss")))
/******/ 	__webpack_require__.O(undefined, ["css/dependencies","css/app","css/fontawesome","css/auth"], () => (__webpack_require__("./resources/sass/app.scss")))
/******/ 	__webpack_require__.O(undefined, ["css/dependencies","css/app","css/fontawesome","css/auth"], () => (__webpack_require__("./resources/sass/dependencies.scss")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/dependencies","css/app","css/fontawesome","css/auth"], () => (__webpack_require__("./resources/sass/fontawesome.scss")))
